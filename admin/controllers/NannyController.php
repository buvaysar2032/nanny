...
/**
 * NannyController implements the CRUD actions for Nanny model.
 *
 * @package admin\controllers
 */
final class NannyController extends AdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate(string $redirect = null): Response|string
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return match ($redirect) {
                ...
                'index' => $this->redirect(UserUrl::setFilters(NannySearch::class)),
    ...
    /**
     * Updates an existing Nanny model.
     *
    ...
    /**
     * Deletes an existing Nanny model.
     *
    ...
    public function actionDelete(int $id): Response
    {
        ...
        return $this->redirect(UserUrl::setFilters(NannySearch::class));
    }

    /**
     * Finds the Nanny model based on its primary key value.
     *
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): Nanny
    {
        if (($model = Nanny::findOne($id)) !== null) {
            return $model;
        }
